            ...
            <form action="" method="post" style="width: 50vw; min-width: 300px;">
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="last_name" placeholder="Soria">
                    </div>
                </div>
                <div class="mb-3">
                <label class="form-label">email</label>
                <input type="email" class="form-control" name="email" placeholder="michaeljamessoria@gmail.com">
                </div>
